...
public class Project extends JFrame implements ActionListener{
    Project(){
        ...
        ImageIcon ic =  new ImageIcon(ClassLoader.getSystemResource("electricity/images/elect1.jpg"));
        ...
        ImageIcon icon1 = new ImageIcon(ClassLoader.getSystemResource("electricity/images/icon1.png"));
        ...
        ImageIcon icon2 = new ImageIcon(ClassLoader.getSystemResource("electricity/images/icon2.png"));
        ...
        ImageIcon icon3 = new ImageIcon(ClassLoader.getSystemResource("electricity/images/icon3.png"));
        ...
        ImageIcon icon4 = new ImageIcon(ClassLoader.getSystemResource("electricity/images/icon4.png"));
        ...
        ImageIcon icon5 = new ImageIcon(ClassLoader.getSystemResource("electricity/images/icon5.png"));
        ...
        ImageIcon icon6 = new ImageIcon(ClassLoader.getSystemResource("electricity/images/icon6.png"));
        ...
        ImageIcon icon7 = new ImageIcon(ClassLoader.getSystemResource("electricity/images/icon7.png"));
        ...
        ImageIcon icon8 = new ImageIcon(ClassLoader.getSystemResource("electricity/images/icon12.png"));
        ...
        ImageIcon icon9 = new ImageIcon(ClassLoader.getSystemResource("electricity/images/icon9.png"));
        ...
        ImageIcon icon10 = new ImageIcon(ClassLoader.getSystemResource("electricity/images/icon10.png"));
        ...
        ImageIcon icon11 = new ImageIcon(ClassLoader.getSystemResource("electricity/images/icon11.png"));
